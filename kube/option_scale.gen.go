...
var scaleOptions = []prompt.Suggest{
	...
	{Text: "--current-replicas", Description: "Precondition for current size. Requires that the current size of the resource match this value in order to scale. -1 (default) for no condition."},
